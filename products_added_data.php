...
function addDataToSheet($conn, $tableName, $tableTitle) {
    ...
    // Set column headings
    $headings = array('ID', 'Product name', 'Price', 'Date Added');
    $colIndex = 0;
...
addDataToSheet($conn, "products_added", "New Products Data");
...
header('Content-Disposition: attachment;filename="products_added.xlsx"');
